    ...
    <nav className="navigation">
        <ul className="navigation__list">
          <li className="navigation__item">
            <Link className={!collapse ? 'navigation__link': 'navigation__link navigation__link_non-active'} to="/about-me">
              ...
              <span className = {!collapse ? 'navigation__text': 'navigation__text_non-active'}>
                About me
              </span>
            </Link>
          </li>
          <li className="navigation__item">
            <Link className={!collapse ? 'navigation__link': 'navigation__link navigation__link_non-active'} to="/education">
              <svg className="navigation__icon" width="14" height="14" viewBox="0 0 14 14" fill="none">
              ...
              <span className={!collapse ? 'navigation__text': 'navigation__text navigation__text_non-active'}>
                Education
              </span>
            </Link>
          </li>
          <li className="navigation__item">
            <Link className={!collapse ? 'navigation__link': 'navigation__link navigation__link_non-active'} to="/experience">
              <svg className="navigation__icon" width="14" height="14" viewBox="0 0 14 14" fill="none">
          ...
          <li className="navigation__item">
            <Link className={!collapse ? 'navigation__link': 'navigation__link navigation__link_non-active'} to="/portfolio">
              <svg className="navigation__icon" width="14" height="14" viewBox="0 0 14 14" fill="none">
